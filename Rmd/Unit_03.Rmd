...
```{r, echo=FALSE,out.width = "100%"}
knitr::include_url("https://www.core-econ.org/the-economy/book/images/web/figure-03-10-a-g.svg",height = "480px")
```
]
.panel[.panel-name[konstantes Grenzprodukt]
```{r, echo=FALSE,out.width = "100%"}
knitr::include_url("https://www.core-econ.org/the-economy/book/images/web/figure-03-15-d.svg",height = "480px")
```
]
]
...
```{r, echo=FALSE,out.width = "100%"}
knitr::include_url("https://www.core-econ.org/the-economy/book/images/web/figure-03-19-b-f.svg",height = "550px")
```
...
```{r, echo=FALSE,out.width = "100%"}
knitr::include_url("https://www.core-econ.org/the-economy/book/images/web/figure-03-20-e.svg",height = "550px")
```
