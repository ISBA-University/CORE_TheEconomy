...
# Wie rational entscheiden Menschen *wirklich* (empirisch)?

.pull-left[
```{r direct-qrcode, echo=FALSE, fig.width=3, fig.height=3, fig.align='center'}
library(qrcode)
my_url <- "https://classex.uni-passau.de/bin/index.php?&institution=1170&course=3156&inactive=0&lang=0#"
# 1. QR-Code im Arbeitsspeicher generieren
qr <- qr_code(my_url)

# 2. Direkt in das Dokument zeichnen
plot(qr)
```
...
.pull-right[
```{r, echo=FALSE,out.width = "100%",fig.align='center'}
knitr::include_graphics('../images/unit03/kahneman_9780374533557.png')
```
.quelle[Bildquelle: [us.macmillan.com](https://us.macmillan.com/books/9780374533557/thinkingfastandslow/)]
]
...
* am Ende ggf. Nudge (Retirement Plan)
