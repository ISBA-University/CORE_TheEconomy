...
### Unit 6: Asymmetrische Information im Unternehmenskontext
...
knitr::include_graphics(xfun::from_root("images","unit06","Profite_LNG_(BerlinerZeitung).png"))
```
...
knitr::include_graphics(xfun::from_root("images","unit06","simon_(nobel.org).jpg"))
```
]
...
.pull-left[
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics(xfun::from_root("images","unit06","coase_(nobel.org).jpg"))
```
]
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics(xfun::from_root("images","unit06","T-kosten_Phasen_(Felden_Hack_S111).PNG"))
```
...
knitr::include_graphics(xfun::from_root("images","unit06","T-kosten_Faktoren_(Felden_Hack_S112).PNG"))
```
...
knitr::include_graphics(xfun::from_root("images","unit06","NIE_(Williamson_2000)_small.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(xfun::from_root("images","unit06","CORE_fig6-1b.png"))
```
...
.pull-right[
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics(xfun::from_root("images","unit06","gewinnmaximierung.png"))
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(xfun::from_root("images","unit06","CORE_fig6-1c.png"))
```
...
#| fig-align: "center"
#| out-width: "80%"
knitr::include_graphics(xfun::from_root("images","unit06","CORE_fig6-2g.png"))
```
...
#| fig-align: "center"
#| out-width: "80%"
knitr::include_graphics(xfun::from_root("images","unit06","CORE_fig6-3.png"))
```
]
]
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(xfun::from_root("images","unit06","CORE_fig6-4g.png"))
```
...
#| fig-align: "center"
#| out-width: "80%"
knitr::include_graphics(xfun::from_root("images","unit06","CORE_fig6-5e.png"))
```
]
...
#| fig-align: "center"
#| out-width: "80%"
knitr::include_graphics(xfun::from_root("images","unit06","CORE_fig6-6f.png"))
```
]
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(xfun::from_root("images","unit06","CORE_fig6-7d.png"))
```
...
knitr::include_graphics(xfun::from_root("images","unit06","Prinzipal-Agent_(Felden_Hack_S113).png"))
```
