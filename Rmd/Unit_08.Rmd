...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url(xfun::from_root("images","unit08","CORE_fig8-4.png"),height="430px")
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_url(xfun::from_root("images","unit08","CORE_fig8-6d.png"),height = "480px")
```
]
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_url(xfun::from_root("images","unit08","CORE_fig8-7d.png"),height = "480px")
```
]
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_url(xfun::from_root("images","unit08","CORE_fig8-8.png"),height = "480px")
```
]
]
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_url(xfun::from_root("images","unit08","CORE_fig8-9a-d.png"),height = "550px")
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_url(xfun::from_root("images","unit08","CORE_fig8-10a.png"),height = "480px")
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_url(xfun::from_root("images","unit08","CORE_fig8-10c.png"),height = "480px")
```
]
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_url(xfun::from_root("images","unit08","CORE_fig8-11d.png"),height = "480px")
```
]
]
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_url(xfun::from_root("images","unit08","CORE_fig8-12e.png"),height = "480px")
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_url(xfun::from_root("images","unit08","CORE_fig8-13.png"),height = "480px")
```
]
.panel[.panel-name[Beispiel]
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_url(xfun::from_root("images","unit08","CORE_fig8-14d.png"),height = "480px")
```
]
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_url(xfun::from_root("images","unit08","CORE_fig8-16c.png"),height = "480px")
```
]
]
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_url(xfun::from_root("images","unit08","CORE_fig8-15d.png"),height = "480px")
```
]
.panel[.panel-name[Mengensteuer]
```{r}
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_url(xfun::from_root("images","unit08","CORE_fig8-17.png"),height = "480px")
```
]
]
...
# Gruppenaufgabe: Trump und die Zölle

.pull-left[
Bildet Gruppen von 3-5 Personen und bearbeitet die folgenden Aufgaben:

1. Entwickelt eine Analyse der US-Zollpolitik für Importe aus der EU im Marshall-Diagramm. Welche Wohlfahrtswirkungen sind für Europäer und US-Amerikaner auf Basis des Modells zu erwarten?

2. Wovon hängt die Lastverteilung im Fall der Zölle ab? Recherchiert Beispiele aus der Zeit seit der Ankündigung der Zölle im April 2025, um empirisch erste Indizien für die Lastverteilung zu erhalten.
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(xfun::from_root("images","unit08","Zoelle_(tagesschau_20250807).png"))
```
Quelle: [tagesschau.de](https://www.tagesschau.de/wirtschaft/weltwirtschaft/zoelle-usa-trump-faq-102.html)
]
```{r,echo=FALSE}
countdown::countdown(
minutes = 15,
