...
knitr::include_graphics(xfun::from_root("images","unit13","BIP_2023.PNG"))
```
.quelle[Quelle: [Destatis (2024)](https://www.destatis.de/DE/Themen/Wirtschaft/Volkswirtschaftliche-Gesamtrechnungen-Inlandsprodukt/Publikationen/Downloads-Inlandsprodukt/zusammenhaenge-pdf-0310100.pdf).]
...
knitr::include_graphics('../images/unit01/Entstehung_2023_(Destatis_S11).png')
```
...
.quellePanURL[Quelle: Eigene Darstellung. Datenbasis: [Destatis (2024)](https://www.destatis.de/DE/Themen/Wirtschaft/Volkswirtschaftliche-Gesamtrechnungen-Inlandsprodukt/Publikationen/Downloads-Inlandsprodukt/inlandsprodukt-erste-ergebnisse-pdf-2180110.pdf?__blob=publicationFile).]
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics('../images/unit01/Primaereinkommen_seit1991_(Destatis_2024).png')
```
.quelle[Quelle: [Destatis (2024)](https://www.destatis.de/DE/Themen/Wirtschaft/Volkswirtschaftliche-Gesamtrechnungen-Inlandsprodukt/Publikationen/Downloads-Inlandsprodukt/zusammenhaenge-pdf-0310100.pdf?__blob=publicationFile).]
