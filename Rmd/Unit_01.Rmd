...
<iframe width="1000" height="550" src="https://www.youtube.com/embed/CAJlZcB6eKw?si=hMAJCIF7ld8WXbSE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>


???

* Fratzscher: Psychologie

* ist also alles nur eine Frage der Perspektive?

* Obst (IW Köln): Strukturprobleme, Wettbewerbsfähigkeit und Standort

* Angesprochen auch Wirtschaftsstruktur: KMU vs. Großkonzerne
...
knitr::include_graphics(xfun::from_root("images/unit01","WKL_BIP_fig13-06.png"))
```
]
]
...
knitr::include_graphics(xfun::from_root("images","unit01","BIP_2024.PNG"))
```
.quelle[Quelle: [Destatis (2025)](https://www.destatis.de/DE/Themen/Wirtschaft/Volkswirtschaftliche-Gesamtrechnungen-Inlandsprodukt/Publikationen/Downloads-Inlandsprodukt/zusammenhaenge-pdf-0310100.pdf).]
...
# Niveau vs. Veränderung

```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics(xfun::from_root("images","unit13","Wachstumsraten_(destatis_2025_S10).PNG"))
```
.quelle[Quelle: [Destatis (2025)](https://www.destatis.de/DE/Themen/Wirtschaft/Volkswirtschaftliche-Gesamtrechnungen-Inlandsprodukt/Publikationen/Downloads-Inlandsprodukt/zusammenhaenge-pdf-0310100.pdf).]
...
* Bezug zum Video Krise am Anfang - zwei Jahre in Folge gab es historisch nach WK2 nur einmal - damals war D der "Kranke Mann Europas"

* Aktuell sieht es so aus, als würde auch 2025 negatives Wachstum bringen

* Zyklisch - Verweis Kapitel 13
...
knitr::include_graphics('../images/unit01/Entstehung_2024_(Destatis_S11).png')
```
.quellePan[Quelle: [Destatis (2024)](https://www.destatis.de/DE/Themen/Wirtschaft/Volkswirtschaftliche-Gesamtrechnungen-Inlandsprodukt/Publikationen/Downloads-Inlandsprodukt/zusammenhaenge-pdf-0310100.pdf).]
]
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_graphics(xfun::from_root("images","unit01","bruttoinlandsprodukt_verwendungsstruktur_2024.svg"))
```

.quellePanURL[Quelle: [Destatis (2025).](https://service.destatis.de/DE/vgr-monitor-deutschland/bip.html)]
...
p
```
.quellePanURL[Quelle: Eigene Darstellung. Datenbasis: [Destatis (2025)](https://www.destatis.de/DE/Themen/Wirtschaft/Volkswirtschaftliche-Gesamtrechnungen-Inlandsprodukt/Publikationen/Downloads-Inlandsprodukt/inlandsprodukt-erste-ergebnisse-pdf-2180110.pdf?__blob=publicationFile).]
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics('../images/unit01/Primaereinkommen_seit1991_(Destatis_2025).png')
```
.quelle[Quelle: [Destatis (2025)](https://www.destatis.de/DE/Themen/Wirtschaft/Volkswirtschaftliche-Gesamtrechnungen-Inlandsprodukt/Publikationen/Downloads-Inlandsprodukt/zusammenhaenge-pdf-0310100.pdf?__blob=publicationFile).]
...
# Weitere Hockeysticks: Umweltbelastung

```{r, echo=FALSE,out.width = "100%"}
knitr::include_graphics(xfun::from_root("images","unit01","Co2stick_COREv1_ch1.png"))
```
...
knitr::include_url("https://books.core-econ.org/the-economy/microeconomics/01-prosperity-inequality-03-climate-change.html#figure-1-2a", height = "550px")
```
...
```{r, echo=FALSE,out.width = "100%"}
knitr::include_graphics(xfun::from_root("images/unit01","bip_zufriedenheit_ch13.png"))
```
]
]

.quellePanURL[vgl. [Kapitel 13](https://books.core-econ.org/the-economy/v1/book/text/13.html#132-output-growth-and-changes-in-unemployment)]
...
<iframe src="https://ourworldindata.org/grapher/the-productivity-of-labour-in-producing-light-lumen-hours-per-hour-of-labour-1800-to-the-present?tab=chart" loading="lazy" style="width: 100%; height: 380px; border: 0px none;" allow="web-share; clipboard-write"></iframe>
]
.panel[.panel-name[Diffusion]
```{r, echo=FALSE,out.width = "70%", fig.align='center'}
knitr::include_graphics('../images/unit01/Diffusion_fig1-4.png')
```
]
]
...
# Entwicklung der Arbeitsproduktivität in D


```{r, echo=FALSE,out.width = "100%", fig.align='center'}
knitr::include_graphics('../images/unit01/Arbeitsproduktivitaet_2024_(Destatis_2025).png')
```
...
```{r, echo=FALSE,out.width = "100%", fig.align='center'}
knitr::include_graphics('../images/unit01/WKL_fig1-12.png')
```
...
```{r, echo=FALSE,out.width = "100%", fig.align='center'}
knitr::include_graphics('../images/unit01/Capitalism_fig1-8.png')
```
]
...
```
.quellePanURL[Quelle: [Edquist (2012).](https://www.researchgate.net/publication/271074148_Knowledge-intensive_Entrepreneurship_National_Systems_of_Innovation_and_European_Varieties_of_Capitalism_A_Conceptual_Framework)]
]
...
<iframe src="https://ourworldindata.org/grapher/divergence-of-gdp-per-capita-among-latecomers-to-the-capitalist-revolution-18002016?tab=chart" loading="lazy" style="width: 100%; height: 550px; border: 0px none;" allow="web-share; clipboard-write"></iframe>
...
## Knappheit, Effizienz und Arbeitsteilung

.blockquote[Wirtschaftsbegriff]
...
---
name: Wirtschaftsbegriff
class: left

# Etymologie "Ökonomie/Ökonomik"

* Griechisch: oικoνoμια:
    * oikos ("Haus", "Haushalt")
    * nemein ("zuweisen"/"einteilen")

* Xenophon:
  * Oikonomikós (ca. 385-370 v.Chr.): "Von der Hauswirtschaft"
  * Póroi (354 v.Chr.): "Über die Staatseinkünfte"

* Ökonomie, Nationalökonomie, Volkswirtschaftslehre.

* Doppeldeutigkeit des Begriffs Wirtschaft (F.A. Hayek):

```{r, echo=FALSE,out.width = "100%"}
knitr::include_graphics(xfun::from_root("images","unit01","wirtschaftsbegriff.PNG"))
```

???

* oικoνoμια: beschreibt Tätigkeit des oikonomos, (Haushälters):
Planvolles Wirtschaften innerhalb eines institutional. Personenverb.,
meist des HH.
* Umfirmierung Nationalökonomie `r fa("circle-right")` Volkswirtschaftslehre: Weimarer
Republik!
* Auflösung der mittelalterlichen Wirtschaft und Übergang zur
Großgesellschaft in Nationalstaaten: Ablauf komplexer
Wirtschaftsprozesse entzieht sich unmittelbarer Anschauung und erfordert
das Denken in Modellen

* Doppeldeutigkeit und Arten der Ordnung (F.A. Hayek)
Organisation: Jemand macht einen (!) Plan, Ordnung: Jeder macht
seinen eigenen Plan.

Prinzipien einer guten Haushaltungskunst und Landwirtschaft (=Mikroökonomie/
BWL) Staatshaushalt etc (=Makro)
...
* Schlaraffenland (freie Güter) vs. Alltagswelt (knappe Güter)
  * absolute Knappheit
  * relative Knappheit

.blockquote[
**Knappheit** bezeichnet einen Zustand, in dem die vorhandenen Güter nicht
ausreichen um die Bedürfnisse der Menschen vollständig zu befriedigen.
]

* Bedürfnisse, Bedarf und Nachfrage.

* "Überwindung der Knappheit": Einschränkung der Bedürfnisse oder
Ausweitung der Güter als philosophische Frage!

* Umgang mit Knappheitsproblem und Funktionen des Wirtschaftens
  * Existenzfunktion
  * Sinnfunktion
  
???

* Existenzfunktion: nicht verhungern, verdursten, erfrieren
* Sinnfunktion: Anerkennung, Teilhabe, Kreativität, Kunst

* freie Güter: sind unbegrenzt verfügbar...
... und Konsument muss nichts tun, um damit seine Bedürfnisse zu befriedigen

* Philosophische Frage: Epikur
  * Primat der Lust: frühkindliches Empfinden (ohne soziale Konditionierung)
gibt natürliche Richtung menschlichen Strebens vor. Lust suchen – Unlust
vermeiden.
  * katastematische Lust (im Sinne anhaltender Daseinslust) vs. kinetische
Lust (im Sinne der Lustvariation): Letztere hat dann - und nur dann - ihre
Berechtigung, wenn sie in der Art der Ausübung oder des
Ausgelebt-Werdens die Daseinsfreude nicht am Ende beeinträchtigt.

  * drei Kategorien von menschlichen Bedürfnissen

```{r, echo=FALSE,out.width = "100%"}
knitr::include_graphics(xfun::from_root("images","unit01","beduerfnisse.PNG"))
```
...
.panelset[
.panel[.panel-name[Begriff]

.blockquote[
Produktion als Herstellung von Wirtschaftsgütern durch Kombination von Produktionsfaktoren im Produktionsprozess unter Nutzung einer bestimmten Technologie.
]
...
#| outwidth: "100%"
#| fig-align: "center"
knitr::include_graphics(xfun::from_root("images","unit01","Produktionsfaktoren_(pixabay).PNG"))
```
.quellePanURL[Bildquelle: [pixabay.com](www.pixabay.com).]
]
.panel[.panel-name[BWL vs. VWL]
```{r}
#| echo: false
#| outwidth: "100%"
#| fig-align: "center"
knitr::include_graphics(xfun::from_root("images","unit01","Produktionsfaktoren_(Altmann_S45).PNG"))
```
.quellePanURL[Quelle: Altmann (2009, S. 54).]
]
]
...
* Zusammenhang Angebot,Produktion, Technologie,
Produktionsfaktoren
* Produktionsfaktoren:
  * Boden (Natur, Ressourcen)
  * Arbeit (Menschliche Arbeitskraft)
  * (Sach-)Kapital (derivativer Faktor – entsteht durch
Kombination von Arbeit und Ressourcen)
  * Humankapital (Wissen)
  * Sozialkapital (Vertrauen)
* Preis für die Produktionsfaktoren: Pacht/Miete (Boden), Lohn
(Arbeit), Zins (Kapital)
...
# "Totem der VWL" ([Bauman, 2016](https://www.youtube.com/watch?v=NF-Rx3wzHgE))

```{tikz, echo=FALSE}
\usetikzlibrary{angles,quotes,babel,calc,matrix,patterns,math,fit,arrows,arrows.meta,shapes.arrows,shapes,shapes.geometric,positioning,intersections,chains,trees,mindmap,shadows,shadows.blur,shadings,backgrounds,colorbrewer,decorations.markings,decorations.pathreplacing,decorations.text}
		\tikzset{font=\normalsize\sffamily}
			\begin{tikzpicture}[yscale=1,scale=.4,thick]
			% Draw gridline.
		%	\draw[style=help lines] (0,-10) grid (10,25);
			% Draw x and f(x) axes.
			\draw[-stealth] (0,0) -- (10,0) node [below] {{\scriptsize Menge}};
			\draw[-stealth] (0,0) -- (0,10) node [left] {{\scriptsize Preis}} ;
			%\foreach \x in {2,4,6,8,10}
			%\node [below] at (\x,0) {\tiny\x};
			%\foreach \y in {-10,-5,0,5,10,15,20,25}
			%\node [left] at (0,\y) {\tiny\y};
			% Plot 
			\draw [color=blue][domain=1:9] plot (\x,{10-\x}) node [above right] {{\scriptsize Nachfrage}};
			\draw [color=green][domain=1:9] plot (\x,{\x}) node [above right] {{\scriptsize Angebot}};
			%\draw[color=red,style=dashed][domain=0:9] plot (\x,{2*\x+10}) node [below right] {{\scriptsize $K(x)=2x+10$}};
			\end{tikzpicture}
```
...
Angebot und Nachfrage im Marshall Diagramm. Benannt nach Alfred
Marshall - Begründer der mathematischen Ökonomie im 19. Jahrhundert.
...
# Effizienz und das ökonomische Prinzip
...
* Effizienzbegriffe
  1. Technische Effizienz (TE): Verhältnis Faktoreinsatz- und
Outputmengen.
  2. Ökonomische Effizienz (ÖE): Einbeziehung von Kosten und Werten.
TE ist notwendige, aber nicht hinreichende Bedingung für ÖE.
  3. Pareto-Effizienz (PE): Effizienz sozialer Systeme.
ÖE notwendige, aber nicht hinreichende Bedingung für PE.

.blockquote[
Ein Zustand ist Pareto-effizient (Synonym: Pareto-optimal), wenn es keine Möglichkeit gibt, durch eine Handlung ein Individuum besser zu stellen, ohne ein anderes Individuum schlechter zu stellen.
]

???
Wichtiges Kriterium, das wir noch einige Male bemühen, u.a. im Kontext
des Coase-Theorems, das für das Thema Kriminalität und Strafrecht besonders wichtig ist.
...
#| out-width: "100%"
#| fig-align: "center"
knitr::include_graphics(xfun::from_root("images","unit01","CCC.PNG"))
```

.quelle[Bildquelle: [Copenhagen Consensus](http://www.copenhagenconsensus.com.).]
...
# Wirtschaften nach dem Rationalprinzip...
...
* Arbeitsteilung **Spezialisierung** ermöglicht, welche wiederum...
* die "Ergiebigkeit" (**Produktivität**) steigert
...
```{r, echo=FALSE,out.width = "100%"}
knitr::include_graphics(xfun::from_root("images","unit01","figure-01-02-c.svg"))
```
]
.panel[.panel-name[1990]
```{r, echo=FALSE,out.width = "100%"}
knitr::include_graphics(xfun::from_root("images","unit01","figure-01-02-d.svg"))
```
]
.panel[.panel-name[2014]
```{r, echo=FALSE,out.width = "100%"}
knitr::include_graphics(xfun::from_root("images","unit01","figure-01-02-e.svg"))
```
]
]
