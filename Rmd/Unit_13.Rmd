...
### Unit 13: Schwankungen der wirtschaftlichen Aktivität und des Preisniveaus
...
knitr::include_graphics(xfun::from_root("images","unit13","Wirtschaftskreislauf_500.png"))
```
]
...
knitr::include_graphics(xfun::from_root("images","unit13","Vieh.png"))
```
...
knitr::include_graphics(xfun::from_root("images","unit13","FinMarkets.png"))
```
.quellePan[Eigene Darstellung.]
]
.panel[.panel-name[Finanzmärkte]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics(xfun::from_root("images","unit13","FinMarkets2.png"))
```
.quellePan[Eigene Darstellung.]
]
.panel[.panel-name[Zinsen]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics(xfun::from_root("images","unit13","zinsen_(BpB_S221)_small.png"))
```
...
* [Inflation](https://www.dashboard-deutschland.de/) vs. Disinflation vs. [Deflation vs. Stagflation](#Deflation)
...
knitr::include_graphics(xfun::from_root("images","unit13","Stagflation_Dimon_(cnbc_2024).png"))
```
.quellePanURL[Quelle: [cnbc.com.](https://www.cnbc.com/2024/05/23/jpm-jamie-dimon-us-could-see-hard-landing-stagflation-is-worst-outcome.html)]
]
.panel[.panel-name[Deflation]
```{r, echo=FALSE,fig.align='center',out.width='60%'}
knitr::include_graphics(xfun::from_root("images","unit13","comic_deflation_(Bauman_S55).png"))
```
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics(xfun::from_root("images","unit13","verbraucherpreise_(BpB_S209)_small.png"))
```
.quellePan[Quelle: [Bundeszentrale für Politische Bildung (2015)](https://www.bpb.de/system/files/dokument_pdf/4938_zb_dtindaten_gesamt.pdf)]
]
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics(xfun::from_root("images","unit13","Ursachen_Inflation_small.png"))
```
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics(xfun::from_root("images","unit13","QTheory.png"))
```
...
```{r, echo=FALSE,fig.align='center'}
knitr::include_graphics(xfun::from_root("images","unit13","bpb_langeReihe_BIP_(Metz_2015)_small.png"))
```
]
.panel[.panel-name[Wachstumsraten]
```{r, echo=FALSE,fig.align='center'}
knitr::include_graphics(xfun::from_root("images","unit13","BIP-Wachstum_langeReihe_(BpB)_small.png"))
```
]
]
...
```{r, echo=FALSE,fig.align='center'}
knitr::include_graphics(xfun::from_root("images","unit13","Outputgap_(SVR_2017_S131)_small.png"))
```
...
```{r, echo=FALSE,fig.align='center'}
knitr::include_graphics(xfun::from_root("images","unit13","Konjunkturzyklus_(Perret_Welfens_2016_S335).png"))
```
...
knitr::include_graphics(xfun::from_root("images","unit13","Zyklen.png"))
```
...
knitr::include_graphics(xfun::from_root("images","unit13","Kondratieff-Zyklen-Technische-Innovationen_W640.jpg"))
```
...
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics(xfun::from_root("images","unit13","Covid_Kreislauf_(Baldwin_2020).png"))
```
...
```{r, echo=FALSE,fig.align='center'}
knitr::include_graphics(xfun::from_root("images","unit13","Wachstumsbeitraege_Nachfragekomponenten_(destatis_2021_S12).png"))
```
]
.panel[.panel-name[2021]
```{r, echo=FALSE,fig.align='center'}
knitr::include_graphics(xfun::from_root("images","unit13","Wachstumsbeitraege_Nachfragekomponenten_(destatis_2022_S12)_small.png"))
```
]
.panel[.panel-name[2022]
```{r, echo=FALSE,fig.align='center'}
knitr::include_graphics(xfun::from_root("images","unit13","Wachstumsbeitraege_Nachfragekomponenten_(destatis_2023_S12)_small.png"))
```
]
.panel[.panel-name[2023]
```{r, echo=FALSE,fig.align='center'}
knitr::include_graphics(xfun::from_root("images","unit13","Wachstumsbeitraege_Nachfragekomponenten_(destatis_2024_S12)_small.png"))
```
]
.panel[.panel-name[2024]
```{r, echo=FALSE,fig.align='center'}
knitr::include_graphics(xfun::from_root("images","unit13","Wachstumsbeitraege_Nachfragekomponenten_(destatis_2025_S12).png"))
```
]
]

.quelle[[Statistisches Bundesamt (2021ff, S. 12)](https://www.destatis.de/DE/Themen/Wirtschaft/Volkswirtschaftliche-Gesamtrechnungen-Inlandsprodukt/Publikationen/Downloads-Inlandsprodukt/zusammenhaenge-pdf-0310100.pdf?__blob=publicationFile)]
...
#| fig-align: "center"
#| out-width: "70%"
knitr::include_graphics(xfun::from_root("images","unit13","CORE_fig10-4a.png"))
```
]
...
#| fig-align: "center"
#| out-width: "80%"
knitr::include_graphics(xfun::from_root("images","unit13","CORE_fig13-10c.png"))
```
]
...
#| fig-align: "center"
#| out-width: "70%"
knitr::include_graphics(xfun::from_root("images","unit13","CORE_fig13-12f.png"))
```
]
]
...
#| fig-align: "center"
#| out-width: "70%"
knitr::include_graphics(xfun::from_root("images","unit13","CORE_fig13-11c.png"))
```
]
...
#| fig-align: "center"
#| out-width: "70%"
knitr::include_graphics(xfun::from_root("images","unit13","CORE_fig13-13c.png"))
```
]
]
...
# Konsumglättung in der Krisensituation

.panelset[

.panel[.panel-name[Covid]
<iframe src="https://fred.stlouisfed.org/graph/graph-landing.php?g=1skll&width=670&height=475" scrolling="no" frameborder="0" style="overflow:hidden; width:1100px; height:480px;" allowTransparency="true" loading="lazy"></iframe>
.quellePanURL[Quelle: [Federal Reserve Bank of St. Louis](https://fred.stlouisfed.org/series/VISASMIHNSA).]
]

.panel[.panel-name[EU-Schuldenkrise]
```{r, echo=FALSE,fig.align='center',out.width='45%'}
knitr::include_graphics(xfun::from_root("images","unit13","Konsumglaettung_Schuldenkrise_(VoxEU).png"))
```

.quellePanURL[Quelle: [VoxEU.org](https://voxeu.org/article/consumption-and-credit-constraints-during-financial-crises)]
...
#| fig-align: "center"
#| out-width: "80%"
knitr::include_graphics(xfun::from_root("images","unit13","CORE_fig13-15.png"))
```
]
...
#| fig-align: "center"
#| out-width: "80%"
knitr::include_graphics(xfun::from_root("images","unit13","CORE_fig13-16.png"))
```
]
]
...
#| fig-align: "center"
#| out-width: "80%"
knitr::include_graphics(xfun::from_root("images","unit13","CORE_fig13-17.png"))
```
...
```{r, echo=FALSE,fig.align='center'}
knitr::include_graphics(xfun::from_root("images","unit13","Konjunkturindikatoren_(Breitung&Jag_2002).png"))
```
...
knitr::include_graphics(xfun::from_root("images","unit13","Shiller_voxEU.png"))
```
...
#| fig-align: "center"
#| out-width: "80%"
knitr::include_graphics(xfun::from_root("images","unit13","CORE_fig9-2.png"))
```
]
.panel[.panel-name[D (2019)]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics(xfun::from_root("images","unit13","Arbeitskraeftepotenzial_(Destatis_2019)_small.png"))
```
.quellePan[Quelle: Destatis (2019).]
]
.panel[.panel-name[Historisch]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_graphics(xfun::from_root("images","unit13","arbeitslosenquote_(BpB_S146)_small.png"))
```
.quellePan[Quelle: [Bundeszentrale für Politische Bildung (2015)](https://www.bpb.de/system/files/dokument_pdf/4938_zb_dtindaten_gesamt.pdf)]
]
.panel[.panel-name[Aktuell]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url(xfun::from_root("images","unit13","Eckwerte_Arbeitsmarkt_(Destatis_2023).png"),height='475px')
```
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_url(xfun::from_root("images","unit13","CORE_fig13-3d.png"),height="480px")
```
]
...
#| fig-align: "center"
#| out-width: "100%"
knitr::include_url(xfun::from_root("images","unit13","CORE_fig13-5.png"),height="480px")
```
]
]
...
.panel[.panel-name[Original]
```{r, echo=FALSE,fig.align='center',out.width='100%'}
knitr::include_url(xfun::from_root("images","unit13","phillips_mod_(Issing_S229).png"),height="480px")
```
...
#| fig-align: "center"
#| out-width: "80%"
knitr::include_graphics(xfun::from_root("images","unit13","CORE_fig15-4a.png"))
```
...
#| fig-align: "center"
#| out-width: "80%"
knitr::include_graphics(xfun::from_root("images","unit13","CORE_fig15-box-a.png"))
```
.quellePanURL[[CORE - The Economy (Unit 15)](https://www.core-econ.org/the-economy/book/text/15.html#153-inflation-the-business-cycle-and-the-phillips-curve).]
]
...
```{r, echo=FALSE,fig.align='center',out.width='80%'}
knitr::include_graphics(xfun::from_root("images","unit13","Flattening_Recession_Curve_(Baldwin_2020).PNG"))
```
