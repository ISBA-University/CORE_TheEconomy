...
library(chromote)
setwd(here::here("Rmd/"))
xaringan_to_pdf("file://Unit_01.html")

xaringan_to_pdf(here::here("Rmd/Unit_01.html"))
#xaringan_to_pdf("https://isba-university.github.io/CORE_Intake2021B/Rmd/Unit_01.html")

renderthis::to_pdf(here::here("Rmd/Unit_04.html"))
